...
const DrawInfoContainer = ({ title }: DrawInfoContainerProps) => {
  return (
    <motion.div
      {...SCROLL_MOTION}
      className='flex flex-col items-center gap-4 w-full bg-gradient-to-b from-white/20 to-white/10 shadow-custom backdrop-blur-custom p-16'
    >
      ...
      <div className='flex w-full justify-evenly mt-10 items-center'>
        ...
        <div className='flex flex-col items-center gap-6'>
          ...
          <p className='text-b-xl font-semibold mt-5 text-white  whitespace-nowrap'>
            나만의 Url 공유
          </p>
        </div>
        <img src='/svg/right_arrow.svg' className=' w-[70px] h-[70px]' />
