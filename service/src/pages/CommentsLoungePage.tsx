    ...
    <>
      ...
      >
        ...
        <div className='flex w-[36.5rem] flex-col items-center gap-9'>
          <div className='flex w-[24rem] flex-col items-start gap-[0.625rem] px-8 py-10 bg-white bg-opacity-10 backdrop-blur-sm rounded-3xl relative'>
          ...
          <div className='flex flex-col items-center gap-4 self-stretch'>
            <div className='flex-row flex space-x-4'>
              <Comment userName='' type='exiting' />
              <Comment userName='' type='gift' />
              <Comment userName='' type='funny' />
            </div>
            <div className='px-4 flex-row flex space-x-4'>
              <Comment userName='' type='car' />
              <Comment userName='' type='good' />
            </div>
